...
void print_usage(const char* prog_name) {
    cout << "Usage: " << prog_name << " [options]\n"
         ...
         << "  -Q <double>     Thermostat inertia parameter [default: auto]\n"
         << "  -h              Show this help\n";
}
...
int main(int argc, char* argv[]) {
    ...
    cout << "=== MD Simulation (Highly Optimized Pipeline & Nosé-Hoover Chains) ===\n";
    cout << "Requested N ~ " << N_req << ", a0 = " << a0 << ", T = " << T_req
         << ", rc = " << rc << ", skin = " << skin << "\n";
    ...
    // Первичный холостой запуск O(N^2) сил для верификации точности оптимизаций
    ...
    cout << "Force validation (particle 0):\n";
    ...
    if (tmax > 0.0) {
        if (use_nh) {
            ...
            cout << "Nosé-Hoover Chains Thermostat (M=2) ENABLED for NVT Ensemble simulation.\n";
        }
